...
<body>
    <div class="container">
        <br><h1 class="text-center text-primary" >Mppsc Quiz:CSAT</h1></br>
    ...
    <form action="csresult.php" method="post" >
        <?php 
           for($i=1;$i<11;$i++)
           {
           $que="select * from csat where qid=$i";
              ...
              while( $rows=mysqli_fetch_array($query))
                {
                    ...
                    <div class="card">
                         ...
                         <?php
                             $que="select * from csanswer where ans_id=$i";
                             $query =mysqli_query($conn,$que);
