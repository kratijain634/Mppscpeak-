...
<body>
    <div class="container">
        <br><h1 class="text-center text-primary" >Mppsc Quiz:Economy</h1></br>
    ...
    <form action="eresult.php" method="post" >
        <?php 
           for($i=1;$i<11;$i++)
           {
           $que="select * from economy where qid=$i";
              ...
              while( $rows=mysqli_fetch_array($query))
                {
                    ...
                    <div class="card">
                         ...
                         <?php
                             $que="select * from eanswers where ans_id=$i";
                             $query =mysqli_query($conn,$que);
