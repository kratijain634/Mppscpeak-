...
<head>
  ...
  <link href="img/icons8-book-60 (2).png" rel="icon">
    <title>geogrophy</title>
</head>
<body>
    <div class="container" >
        <br><h1 class="text-center text-primary" >Mppsc Quiz:Geography</h1></br>
    ...
    <form action="gresult.php" method="post" >
        <?php 
           for($i=1;$i<11;$i++)
           {
           $que="select * from geogrophy where qid=$i";
              ...
              while( $rows=mysqli_fetch_array($query))
                {
                    ...
                    <div class="card">
                         ...
                         <?php
                             $que="select * from ganswers where ans_id=$i";
                             $query =mysqli_query($conn,$que);
